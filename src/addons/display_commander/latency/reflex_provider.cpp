...
bool ReflexProvider::IsInitialized() const {
    return reflex_manager_.IsInitialized();
}

uint64_t ReflexProvider::IncreaseFrameId() {
    return reflex_manager_.IncreaseFrameId();
}
