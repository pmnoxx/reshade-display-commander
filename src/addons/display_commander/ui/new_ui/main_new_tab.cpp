...
void DrawMainNewTab() {
  ...
  // Screensaver Settings Section
  {
    ...
    const char *screensaver_modes[] = {"Default", "Disable in Background",
                                       "Disabled"};
    ...
    if (ImGui::IsItemHovered()) {
      ImGui::SetTooltip("Controls screensaver behavior:\n"
                        "Default: Normal screensaver behavior\n"
                        "Disable in Background: Prevents screensaver when game "
                        "is in background\n"
                        "Disabled: Always prevents screensaver");
    }
  }
