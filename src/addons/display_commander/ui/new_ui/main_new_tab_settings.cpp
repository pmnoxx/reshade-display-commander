...
MainNewTabSettings::MainNewTabSettings()
    : window_mode("window_mode", 0, {"Borderless Windowed (Aspect Ratio)", "Borderless Windowed (Width/Height)", "Borderless Fullscreen"}, "renodx_main_tab"),
      ...
      sleep_after_present_ms("sleep_after_present_ms", ::s_sleep_after_present_ms, 0.0f, 0.0f, 20.0f, "renodx_main_tab"),
      ...
      mute_in_background_if_other_audio("mute_in_background_if_other_audio", ::s_mute_in_background_if_other_audio, true, "renodx_main_tab"),
