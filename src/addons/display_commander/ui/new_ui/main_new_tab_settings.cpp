...
MainNewTabSettings::MainNewTabSettings()
    : window_mode("window_mode", 0, {"Borderless Windowed (Aspect Ratio)", "Borderless Windowed (Width/Height)", "Borderless Fullscreen"}, "renodx_main_tab"),
      ...
      fps_limiter_mode("fps_limiter_mode", 0, {"Custom (Sleep/Spin)", "Latency Sync"}, "renodx_main_tab"),
      latent_sync_mode("latent_sync_mode", 0, {"Sync to VBlank", "Sync based on Scanline (Experimental)"}, "renodx_main_tab"),
      scanline_threshold("scanline_threshold", 1700, 0, 10000, "renodx_main_tab"),
