...
template <typename T> inline T *Get(const reshade::api::api_object *api_object) {
    uint64_t res;
...
template <typename T, typename... Args> inline T *Create(reshade::api::api_object *api_object, Args &&...args) {
    uint64_t res;
...
template <typename T> inline void Delete(reshade::api::api_object *api_object) {
