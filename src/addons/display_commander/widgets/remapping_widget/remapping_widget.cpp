...
namespace display_commander::widgets::remapping_widget
{
    ...
    void RemappingWidget::DrawAddRemapDialog()
    {
        ...
        if (ImGui::BeginPopupModal("Add Remapping", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
            ...
            if (ImGui::Combo("##GamepadButton", &dialog_state_.selected_gamepad_button,
                            gamepad_buttons, 15)) {
                // Update selection
            }
            ...
            const char* input_methods[] = {
                "SendInput", "keybd_event", "SendMessage", "PostMessage"
            };
            if (ImGui::Combo("##InputMethod", &dialog_state_.selected_input_method,
                            input_methods, 4)) {
                // Update selection
            }
    ...
    void RemappingWidget::DrawEditRemapDialog()
    {
        ...
        if (ImGui::BeginPopupModal("Edit Remapping", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
            ...
            ImGui::Combo("##GamepadButton", &dialog_state_.selected_gamepad_button,
                        gamepad_buttons, 15);
            ...
            ImGui::Combo("##InputMethod", &dialog_state_.selected_input_method,
                        input_methods, 4);
    ...
    void RemappingWidget::LoadSettings()
    {
        ...
        if (reshade::get_config_value(nullptr, "DisplayCommander.RemappingWidget", "SelectedController", selected_controller)) {
