...
DeveloperTabSettings::DeveloperTabSettings()
    : prevent_fullscreen("PreventFullscreen", true, "DisplayCommander"),
      ...
      nvapi_fullscreen_prevention("NvapiFullscreenPrevention", s_nvapi_fullscreen_prevention, s_nvapi_fullscreen_prevention.load(),
                                  "DisplayCommander"),

      // Minimal NVIDIA Reflex controls
      reflex_auto_configure("ReflexAutoConfigure", s_reflex_auto_configure, s_reflex_auto_configure.load(), "DisplayCommander"),
      ...
      reflex_generate_markers("ReflexGenerateMarkers", s_reflex_generate_markers, s_reflex_generate_markers.load(), "DisplayCommander"),
      ...
      reflex_supress_native("ReflexSupressNative", s_reflex_supress_native, s_reflex_supress_native.load(), "DisplayCommander"),

      enable_mute_unmute_shortcut("EnableMuteUnmuteShortcut", s_enable_mute_unmute_shortcut, s_enable_mute_unmute_shortcut.load(), "DisplayCommander"),
      enable_background_toggle_shortcut("EnableBackgroundToggleShortcut", s_enable_background_toggle_shortcut, s_enable_background_toggle_shortcut.load(),
                                        "DisplayCommander"),
      enable_timeslowdown_shortcut("EnableTimeslowdownShortcut", s_enable_timeslowdown_shortcut, s_enable_timeslowdown_shortcut.load(), "DisplayCommander"),
      enable_adhd_toggle_shortcut("EnableAdhdToggleShortcut", s_enable_adhd_toggle_shortcut, s_enable_adhd_toggle_shortcut.load(), "DisplayCommander"),
      enable_autoclick_shortcut("EnableAutoclickShortcut", s_enable_autoclick_shortcut, s_enable_autoclick_shortcut.load(), "DisplayCommander"),
