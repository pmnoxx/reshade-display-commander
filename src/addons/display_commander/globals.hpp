...
enum SwapchainEventIndex {
    ...
    SWAPCHAIN_EVENT_PRESENT_UPDATE_BEFORE2_UNUSED = 6,
    ...
    // NVAPI Reflex hooks
    SWAPCHAIN_EVENT_NVAPI_D3D_SET_LATENCY_MARKER = 76,
    SWAPCHAIN_EVENT_NVAPI_D3D_SET_SLEEP_MODE = 77,
    SWAPCHAIN_EVENT_NVAPI_D3D_SLEEP = 78,
    SWAPCHAIN_EVENT_NVAPI_D3D_GET_LATENCY = 79,
    // NGX Parameter hooks
    SWAPCHAIN_EVENT_NGX_PARAMETER_SETF = 80,
    SWAPCHAIN_EVENT_NGX_PARAMETER_SETD = 81,
    SWAPCHAIN_EVENT_NGX_PARAMETER_SETI = 82,
    SWAPCHAIN_EVENT_NGX_PARAMETER_SETUI = 83,
    SWAPCHAIN_EVENT_NGX_PARAMETER_SETULL = 84,
    // NGX Parameter getter hooks
    SWAPCHAIN_EVENT_NGX_PARAMETER_GETI = 85,
    SWAPCHAIN_EVENT_NGX_PARAMETER_GETUI = 86,
    SWAPCHAIN_EVENT_NGX_PARAMETER_GETULL = 87,
    SWAPCHAIN_EVENT_NGX_PARAMETER_GETVOIDPOINTER = 88,
    // Streamline hooks
    SWAPCHAIN_EVENT_STREAMLINE_SL_INIT = 89,
    SWAPCHAIN_EVENT_STREAMLINE_SL_IS_FEATURE_SUPPORTED = 90,
